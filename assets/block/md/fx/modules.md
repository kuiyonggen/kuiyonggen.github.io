...
Instead, they should use a [parameter object](#parameter-objects).
...
[add new optional dependencies](#adding-new-parameters)
...
Instead, they should use a [result object](#result-objects).
...
[produce new results](#adding-new-results)
in a backwards-compatible manner without changing the function signature.
